...
s3 = boto3.client('s3',
                    aws_access_key_id='AKIA476BNLHSFAFD6LPX',
                    aws_secret_access_key= '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'
                    #aws_session_token=keys.AWS_SESSION_TOKEN
                     )

textract = boto3.client('textract',
                        aws_access_key_id='AKIA476BNLHSFAFD6LPX',
                        aws_secret_access_key = '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', region_name='us-east-1')

comprehend = boto3.client('comprehendmedical', aws_access_key_id='AKIA476BNLHSFAFD6LPX', 
                        aws_secret_access_key = '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', region_name='us-east-1')
